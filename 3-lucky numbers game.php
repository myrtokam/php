...
if(isset($_POST['play']))
{
    ...
    $joker = $_POST["joker"];
     ...
     {
        echo"<h3> try again! you gave duplicate numbers!</h3>";
     }
     else 
     {
...
do{
$lottery=array(rand(1,45),rand(1,45)rand(1,45),rand(1,45),rand(1,45));
$lo_joker=rand(1,20);
sort($lottery);
}
while(count($lottery)!=count(array_unique($lottery)));
echo"<h3>the lucky numbers are:</h3>";
